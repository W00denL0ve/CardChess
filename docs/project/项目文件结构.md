...
└── docs/                                   #   架构文档
    ...
    │   ├── system-overview/                │       系统级概览（LLD）
    │   │   ├── card-system.md              │         卡牌系统
    │   │   ├── turn-combat-system.md        │         回合战斗系统
    │   │   ├── level-system.md              │         关卡系统
    │   │   ├── unit-system.md               │         单位系统
    │   │   ├── ai-system.md                 │         AI 系统
    │   │   ├── ui-interaction-system.md     │         UI 与交互
    │   │   ├── save-resource-system.md      │         存档与资源
    │   │   └── editor-tools-system.md       │         编辑器工具
    │   ├── module-details/                  │       模块详细（暂不维护）
    │   ├── 系统模块详解.md                  │       [待弃用]
    │   └── 数据与表现分离设计.md             │       [待弃用]
    ├── guides/                             #     制作指南
