...
public class UnitMoveRequestEvent : GameEvent
{
    ...
    public UnitMoveRequestEvent(Unit unit, Vector2Int from, Vector2Int to, EffectContext context = default) { Unit = unit; From = from; To = to; Context = context; }
}
...
public class UnitMovedEvent : GameEvent
{
    ...
    public Vector2Int To { get; }
    public EffectContext Context { get; }
    public UnitMovedEvent(Unit unit, Vector2Int from, Vector2Int to, EffectContext context = default) { Unit = unit; From = from; To = to; Context = context; }
}
